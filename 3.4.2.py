...
def create_grade_distribution(scores, subject_code, year):
    ...
    plt.bar(bin_centers, hist, width=0.08, alpha=0.8, color='dodgerblue')
    ...
    plt.xticks(np.arange(0, 10.1, 0.5), rotation=45, fontsize=8)
...
if __name__ == "__main__":
    folders_and_years = [
        ("/home/nifi/HOCTAP/data/Diem_KTHP/File csv 22-23", "22-23"),
        ("/home/nifi/HOCTAP/data/Diem_KTHP/File csv 23-24", "23-24"),
        ("/home/nifi/HOCTAP/data/Diem_KTHP/File csv 24-25", "24-25"),
    ]
            ...
            if filename.endswith('.csv'):
                ...
                if scores is not None and not scores.empty:
                    try:
                        ...
                        # Lưu biểu đồ
                        output_dir = os.path.join('/home/nifi/HOCTAP/Do_thi_KQ_KTHP', year)
